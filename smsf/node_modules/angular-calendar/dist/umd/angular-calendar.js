...
var CalendarMomentDateFormatter = (function () {
    ...
    CalendarMomentDateFormatter = __decorate([
        __param(0, __WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"](MOMENT)),
...
var CalendarNativeDateFormatter = (function () {
    ...
    CalendarNativeDateFormatter.prototype.weekViewTitle = function (_a) {
        ...
        var weekNumber = __WEBPACK_IMPORTED_MODULE_0_date_fns_get_iso_week___default.a(date);
...
var CalendarUtils = (function () {
    ...
    CalendarUtils.prototype.getMonthView = function (args) {
        return __WEBPACK_IMPORTED_MODULE_1_calendar_utils__["getMonthView"](args);
    };
    CalendarUtils.prototype.getWeekViewHeader = function (args) {
        return __WEBPACK_IMPORTED_MODULE_1_calendar_utils__["getWeekViewHeader"](args);
    };
    CalendarUtils.prototype.getWeekView = function (args) {
        return __WEBPACK_IMPORTED_MODULE_1_calendar_utils__["getWeekView"](args);
    };
    CalendarUtils.prototype.getDayView = function (args) {
        return __WEBPACK_IMPORTED_MODULE_1_calendar_utils__["getDayView"](args);
    };
    CalendarUtils.prototype.getDayViewHourGrid = function (args) {
        return __WEBPACK_IMPORTED_MODULE_1_calendar_utils__["getDayViewHourGrid"](args);
    };
    CalendarUtils = calendarUtils_provider___decorate([
        calendarUtils_provider___WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"]()
    ], CalendarUtils);
...
var calendarDayView_component_CalendarDayViewComponent = (function () {
    ...
    CalendarDayViewComponent.prototype.resizeEnded = function (dayEvent) {
        ...
        if (currentResize.edge === 'top') {
            newStart = __WEBPACK_IMPORTED_MODULE_2_date_fns_add_minutes___default.a(newStart, minutesMoved);
        }
        else if (newEnd) {
            newEnd = __WEBPACK_IMPORTED_MODULE_2_date_fns_add_minutes___default.a(newEnd, minutesMoved);
        }
    ...
    CalendarDayViewComponent.prototype.eventDragged = function (dayEvent, draggedInPixels) {
        ...
        var newStart = __WEBPACK_IMPORTED_MODULE_2_date_fns_add_minutes___default.a(dayEvent.event.start, minutesMoved);
        var newEnd;
        if (dayEvent.event.end) {
            newEnd = __WEBPACK_IMPORTED_MODULE_2_date_fns_add_minutes___default.a(dayEvent.event.end, minutesMoved);
        }
        this.eventTimesChanged.emit({ newStart: newStart, newEnd: newEnd, event: dayEvent.event });
    };
    ...
    calendarDayView_component___decorate([
        calendarDayView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    calendarDayView_component___decorate([
        calendarDayView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"](),
    ...
    CalendarDayViewComponent = calendarDayView_component___decorate([
        calendarDayView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        ...
        calendarDayView_component___param(2, calendarDayView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"](calendarDayView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["LOCALE_ID"])),
        calendarDayView_component___metadata("design:paramtypes", [calendarDayView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["ChangeDetectorRef"], CalendarUtils, String])
...
var calendarWeekView_component_CalendarWeekViewComponent = (function () {
    ...
    CalendarWeekViewComponent.prototype.resizeEnded = function (weekEvent) {
        ...
        if (currentResize.edge === 'left') {
            newStart = __WEBPACK_IMPORTED_MODULE_2_date_fns_add_days___default.a(newStart, daysDiff);
        }
        else if (newEnd) {
            newEnd = __WEBPACK_IMPORTED_MODULE_2_date_fns_add_days___default.a(newEnd, daysDiff);
        }
    ...
    CalendarWeekViewComponent.prototype.eventDragged = function (weekEvent, draggedByPx, dayWidth) {
        ...
        var newStart = __WEBPACK_IMPORTED_MODULE_2_date_fns_add_days___default.a(weekEvent.event.start, daysDragged);
        var newEnd;
        if (weekEvent.event.end) {
            newEnd = __WEBPACK_IMPORTED_MODULE_2_date_fns_add_days___default.a(weekEvent.event.end, daysDragged);
        }
        this.eventTimesChanged.emit({ newStart: newStart, newEnd: newEnd, event: weekEvent.event });
    };
    /**
    ...
    calendarWeekView_component___decorate([
        calendarWeekView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    calendarWeekView_component___decorate([
        calendarWeekView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"](),
    ...
    CalendarWeekViewComponent = calendarWeekView_component___decorate([
        calendarWeekView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        ...
        calendarWeekView_component___param(2, calendarWeekView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"](calendarWeekView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["LOCALE_ID"])),
        calendarWeekView_component___metadata("design:paramtypes", [calendarWeekView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["ChangeDetectorRef"], CalendarUtils, String])
...
var calendarMonthView_component_CalendarMonthViewComponent = (function () {
    ...
    CalendarMonthViewComponent.prototype.eventDropped = function (day, event) {
        var year = __WEBPACK_IMPORTED_MODULE_8_date_fns_get_year___default.a(day.date);
        var month = __WEBPACK_IMPORTED_MODULE_7_date_fns_get_month___default.a(day.date);
        var date = __WEBPACK_IMPORTED_MODULE_6_date_fns_get_date___default.a(day.date);
        var newStart = __WEBPACK_IMPORTED_MODULE_3_date_fns_set_date___default.a(__WEBPACK_IMPORTED_MODULE_4_date_fns_set_month___default.a(__WEBPACK_IMPORTED_MODULE_5_date_fns_set_year___default.a(event.start, year), month), date);
        var newEnd;
        if (event.end) {
            var secondsDiff = __WEBPACK_IMPORTED_MODULE_9_date_fns_difference_in_seconds___default.a(newStart, event.start);
            newEnd = __WEBPACK_IMPORTED_MODULE_10_date_fns_add_seconds___default.a(event.end, secondsDiff);
        }
    ...
    CalendarMonthViewComponent.prototype.checkActiveDayIsOpen = function () {
        ...
        if (this.activeDayIsOpen === true) {
            this.openDay = this.view.days.find(function (day) { return __WEBPACK_IMPORTED_MODULE_2_date_fns_is_same_day___default.a(day.date, _this.viewDate); });
    ...
    calendarMonthView_component___decorate([
        calendarMonthView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    calendarMonthView_component___decorate([
        calendarMonthView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"](),
    ...
    CalendarMonthViewComponent = calendarMonthView_component___decorate([
        calendarMonthView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        ...
        calendarMonthView_component___param(2, calendarMonthView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"](calendarMonthView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["LOCALE_ID"])),
        calendarMonthView_component___metadata("design:paramtypes", [calendarMonthView_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["ChangeDetectorRef"], CalendarUtils, String])
...
var CalendarMonthViewHeaderComponent = (function () {
    ...
    calendarMonthViewHeader_component___decorate([
        calendarMonthViewHeader_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    CalendarMonthViewHeaderComponent = calendarMonthViewHeader_component___decorate([
        calendarMonthViewHeader_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
...
var CalendarEventActionsComponent = (function () {
    ...
    calendarEventActions_component___decorate([
        calendarEventActions_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    CalendarEventActionsComponent = calendarEventActions_component___decorate([
        calendarEventActions_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
...
var CalendarEventTitleComponent = (function () {
    ...
    calendarEventTitle_component___decorate([
        calendarEventTitle_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    CalendarEventTitleComponent = calendarEventTitle_component___decorate([
        calendarEventTitle_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
...
var CalendarMonthCellComponent = (function () {
    ...
    calendarMonthCell_component___decorate([
        calendarMonthCell_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    calendarMonthCell_component___decorate([
        calendarMonthCell_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"](),
    ...
    CalendarMonthCellComponent = calendarMonthCell_component___decorate([
        calendarMonthCell_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
...
var CalendarOpenDayEventsComponent = (function () {
    ...
    calendarOpenDayEvents_component___decorate([
        calendarOpenDayEvents_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    calendarOpenDayEvents_component___decorate([
        calendarOpenDayEvents_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"](),
    ...
    CalendarOpenDayEventsComponent = calendarOpenDayEvents_component___decorate([
        calendarOpenDayEvents_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
            selector: 'mwl-calendar-open-day-events',
            template: "\n    <ng-template #defaultTemplate>\n      <div\n        *ngFor=\"let event of events\"\n        [ngClass]=\"event?.cssClass\"\n        mwlDraggable\n        [dropData]=\"{event: event}\"\n        [dragAxis]=\"{x: event.draggable, y: event.draggable}\">\n        <span\n          class=\"cal-event\"\n          [style.backgroundColor]=\"event.color.primary\">\n        </span>\n        <mwl-calendar-event-title\n          [event]=\"event\"\n          view=\"month\"\n          (mwlClick)=\"eventClicked.emit({event: event})\">\n        </mwl-calendar-event-title>\n        <mwl-calendar-event-actions [event]=\"event\"></mwl-calendar-event-actions>\n      </div>\n    </ng-template>\n    <div class=\"cal-open-day-events\" [@collapse] *ngIf=\"isOpen\">\n      <ng-template\n        [ngTemplateOutlet]=\"customTemplate || defaultTemplate\"\n        [ngTemplateOutletContext]=\"{\n          events: events,\n          eventClicked: eventClicked\n        }\">\n      </ng-template>\n    </div>\n  ",
            animations: [
                __WEBPACK_IMPORTED_MODULE_1__angular_animations__["trigger"]('collapse', [
                    __WEBPACK_IMPORTED_MODULE_1__angular_animations__["transition"]('void => *', [
                        __WEBPACK_IMPORTED_MODULE_1__angular_animations__["style"]({ height: 0 }),
                        __WEBPACK_IMPORTED_MODULE_1__angular_animations__["animate"]('150ms linear', __WEBPACK_IMPORTED_MODULE_1__angular_animations__["style"]({ height: '*' }))
                    ]),
                    __WEBPACK_IMPORTED_MODULE_1__angular_animations__["transition"]('* => void', [
                        __WEBPACK_IMPORTED_MODULE_1__angular_animations__["style"]({ height: '*' }),
                        __WEBPACK_IMPORTED_MODULE_1__angular_animations__["animate"]('150ms linear', __WEBPACK_IMPORTED_MODULE_1__angular_animations__["style"]({ height: 0 }))
                    ])
                ])
            ]
        })
...
var CalendarWeekViewHeaderComponent = (function () {
    ...
    calendarWeekViewHeader_component___decorate([
        calendarWeekViewHeader_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    calendarWeekViewHeader_component___decorate([
        calendarWeekViewHeader_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"](),
    ...
    CalendarWeekViewHeaderComponent = calendarWeekViewHeader_component___decorate([
        calendarWeekViewHeader_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
...
var CalendarWeekViewEventComponent = (function () {
    ...
    calendarWeekViewEvent_component___decorate([
        calendarWeekViewEvent_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    calendarWeekViewEvent_component___decorate([
        calendarWeekViewEvent_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"](),
    ...
    CalendarWeekViewEventComponent = calendarWeekViewEvent_component___decorate([
        calendarWeekViewEvent_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
...
var CalendarAllDayEventComponent = (function () {
    ...
    calendarAllDayEvent_component___decorate([
        calendarAllDayEvent_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    calendarAllDayEvent_component___decorate([
        calendarAllDayEvent_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"](),
    ...
    CalendarAllDayEventComponent = calendarAllDayEvent_component___decorate([
        calendarAllDayEvent_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
...
var CalendarDayViewHourSegmentComponent = (function () {
    ...
    calendarDayViewHourSegment_component___decorate([
        calendarDayViewHourSegment_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    CalendarDayViewHourSegmentComponent = calendarDayViewHourSegment_component___decorate([
        calendarDayViewHourSegment_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
...
var CalendarDayViewEventComponent = (function () {
    ...
    calendarDayViewEvent_component___decorate([
        calendarDayViewEvent_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    calendarDayViewEvent_component___decorate([
        calendarDayViewEvent_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"](),
    ...
    CalendarDayViewEventComponent = calendarDayViewEvent_component___decorate([
        calendarDayViewEvent_component___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
...
var CalendarTooltipWindowComponent = (function () {
    ...
    calendarTooltip_directive___decorate([
        calendarTooltip_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    CalendarTooltipWindowComponent = calendarTooltip_directive___decorate([
        calendarTooltip_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
...
var calendarTooltip_directive_CalendarTooltipDirective = (function () {
    ...
    calendarTooltip_directive___decorate([
        calendarTooltip_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"]('mwlCalendarTooltip'),
        calendarTooltip_directive___metadata("design:type", String)
    ], CalendarTooltipDirective.prototype, "contents", void 0);
    calendarTooltip_directive___decorate([
        calendarTooltip_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"]('tooltipPlacement'),
        calendarTooltip_directive___metadata("design:type", String)
    ], CalendarTooltipDirective.prototype, "placement", void 0);
    calendarTooltip_directive___decorate([
        calendarTooltip_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"]('tooltipTemplate'),
        calendarTooltip_directive___metadata("design:type", calendarTooltip_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["TemplateRef"])
    ], CalendarTooltipDirective.prototype, "customTemplate", void 0);
    calendarTooltip_directive___decorate([
        calendarTooltip_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"]('tooltipEvent'),
        calendarTooltip_directive___metadata("design:type", Object)
    ], CalendarTooltipDirective.prototype, "event", void 0);
    calendarTooltip_directive___decorate([
        calendarTooltip_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"]('tooltipAppendToBody'),
        calendarTooltip_directive___metadata("design:type", Boolean)
    ], CalendarTooltipDirective.prototype, "appendToBody", void 0);
    calendarTooltip_directive___decorate([
        calendarTooltip_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["HostListener"]('mouseenter'),
    ...
    calendarTooltip_directive___decorate([
        calendarTooltip_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["HostListener"]('mouseleave'),
        calendarTooltip_directive___metadata("design:type", Function),
        calendarTooltip_directive___metadata("design:paramtypes", []),
        calendarTooltip_directive___metadata("design:returntype", void 0)
    ], CalendarTooltipDirective.prototype, "onMouseOut", null);
    CalendarTooltipDirective = calendarTooltip_directive___decorate([
        calendarTooltip_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Directive"]({
            selector: '[mwlCalendarTooltip]'
        }),
        calendarTooltip_directive___param(5, calendarTooltip_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"](__WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["DOCUMENT"])),
...
var CalendarPreviousViewDirective = (function () {
    ...
    calendarPreviousView_directive___decorate([
        calendarPreviousView_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    calendarPreviousView_directive___decorate([
        calendarPreviousView_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"](),
    ...
    calendarPreviousView_directive___decorate([
        calendarPreviousView_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["HostListener"]('click'),
    ...
    CalendarPreviousViewDirective = calendarPreviousView_directive___decorate([
        calendarPreviousView_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Directive"]({
...
var CalendarNextViewDirective = (function () {
    ...
    calendarNextView_directive___decorate([
        calendarNextView_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
    ...
    calendarNextView_directive___decorate([
        calendarNextView_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"](),
    ...
    calendarNextView_directive___decorate([
        calendarNextView_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["HostListener"]('click'),
    ...
    CalendarNextViewDirective = calendarNextView_directive___decorate([
        calendarNextView_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Directive"]({
...
var CalendarTodayDirective = (function () {
    ...
    CalendarTodayDirective.prototype.onClick = function () {
        this.viewDateChange.emit(__WEBPACK_IMPORTED_MODULE_1_date_fns_start_of_today___default.a());
    };
    calendarToday_directive___decorate([
        calendarToday_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"](),
        calendarToday_directive___metadata("design:type", Date)
    ], CalendarTodayDirective.prototype, "viewDate", void 0);
    calendarToday_directive___decorate([
        calendarToday_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"](),
    ...
    calendarToday_directive___decorate([
        calendarToday_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["HostListener"]('click'),
    ...
    CalendarTodayDirective = calendarToday_directive___decorate([
        calendarToday_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Directive"]({
...
var ClickDirective = (function () {
    ...
    click_directive___decorate([
        click_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"]('mwlClick'),
    ...
    ClickDirective = click_directive___decorate([
        click_directive___WEBPACK_IMPORTED_MODULE_0__angular_core__["Directive"]({
            selector: '[mwlClick]'
        }),
...
var calendarDate_pipe_CalendarDatePipe = (function () {
    ...
    CalendarDatePipe = calendarDate_pipe___decorate([
        calendarDate_pipe___WEBPACK_IMPORTED_MODULE_0__angular_core__["Pipe"]({
            name: 'calendarDate'
        }),
        calendarDate_pipe___param(1, calendarDate_pipe___WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"](calendarDate_pipe___WEBPACK_IMPORTED_MODULE_0__angular_core__["LOCALE_ID"])),
...
var calendarEventTitle_pipe_CalendarEventTitlePipe = (function () {
    ...
    CalendarEventTitlePipe = calendarEventTitle_pipe___decorate([
        calendarEventTitle_pipe___WEBPACK_IMPORTED_MODULE_0__angular_core__["Pipe"]({
