...
export class Animations
{
    ...
    public static routerTransitionLeft = trigger('routerTransitionLeft', [
        ...
        transition('* => *', [
            query('smsf-content > :enter, smsf-content > :leave', [
                style({
                    position: 'absolute',
                    top     : 0,
                    bottom  : 0,
            ...
            sequence([
                ...
                query('smsf-content > :leave', animateChild(), {optional: true}),
                query('smsf-content > :enter', animateChild(), {optional: true})
            ])
        ])
    ]);
